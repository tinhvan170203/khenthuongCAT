...
var tuyentruyenRouter = require('./routes/tuyentruyen');
var vanngheRouter = require('./routes/vannghethethao');
var phongRouter = require('./routes/admin/phongbase');
var dieulenhRouter = require('./routes/dieulenh');
...
const url = 'mongodb://localhost:27017/congtacdang';
...
app.use('/tuyentruyen', tuyentruyenRouter);
app.use('/vannghethethao', vanngheRouter);
app.use('/admin', phongRouter);
app.use('/congtacdieulenh', dieulenhRouter);
app.use('/quantrihethong', superAdminRouter);
app.use('/conganhungyen/thiduakhenthuong', clientRouter);
app.use('/pm/thiduakhenthuong', homeRouter);

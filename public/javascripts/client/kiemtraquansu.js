$(document).ready(function() {
    ...
    $('#btn-search-time').click(function() {
        let nam = $('#nam').val();
        $.ajax({
            url: `/conganhungyen/thiduakhenthuong/congtacdieulenh/ketquakiemtraquansu/${nam}`,
    ...
    $('#btn-search-time-ki-luat').click(function() {
     ...
     `);
        $.ajax({
            url: '/conganhungyen/thiduakhenthuong/congtacdieulenh/dieulenhquansu/khongdat/' + nam,
            success: function(data) {
                tableTieubieu(data)
            }
        })

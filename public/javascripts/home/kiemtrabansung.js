$(document).ready(function() {
            ...
            result.forEach((item, index) => {
                $('#bang2').append(`
                              <tr>
                                      ...
                                      <td>${item.ghichu}</td>
                                      <td style="text-align: center"><a class="download" href="/congtacdieulenh/quantri/kiemtra/bansung/download/${item.tep}"><i style="font-size:20px" class="fas fa-file-word"></i></a></td>
                              </tr>
                              `)
            });
        }
    ...
    $('#btn-search-vianninh').click(function(e) {
        ...
        $.ajax({
            url: `/pm/thiduakhenthuong/filterKiemtrabansung`,
            data: { nam },
        ...
        $.ajax({
            url: `/pm/thiduakhenthuong/filterKiemtratheluc/bansung/khongdat/${nam}`,
            success: function(data) {
                dataRender4 = data;
